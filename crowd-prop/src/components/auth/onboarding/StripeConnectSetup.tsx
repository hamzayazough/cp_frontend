  ...
  const handleSetupStripe = async () => {
    ...
    try {
      ...
      if (!accountResponse.success) {
        throw new Error(
          accountResponse.message || "Failed to create payment account"
        );
      }
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700">
              To receive payments from campaigns, we need to verify your
              identity and setup your payment account through our secure payment
              processor.
            </p>
          </div>
        </div>
