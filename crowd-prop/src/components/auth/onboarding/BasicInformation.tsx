...
export default function BasicInformation({ data, onUpdate, onNext, onBack }: BasicInformationProps) {
      ...
      <div className="space-y-4">
        ...
        <div className="border-t pt-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              <label htmlFor="snapchat" className="block text-sm font-medium text-gray-700 mb-1">
                Snapchat
              </label>
              <div className="relative">
                <span className="absolute left-3 top-2 text-gray-500 text-sm">@</span>
