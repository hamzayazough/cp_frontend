...
export default function BasicInfoStep({ formData, updateFormData }: BasicInfoStepProps) {
  ...
  const validateField = (field: keyof CampaignWizardFormData, value: unknown) => {
    switch (field) {
      case 'title':
      ...
      case 'file':
        if (!value) {
          return 'Please upload a file for your campaign';
        }
        break;
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!allowedTypes.includes(file.type)) {
      setErrors(prev => ({ ...prev, file: 'Please upload a valid image, video, or PDF file' }));
      return;
    }
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6">
        ...
        {formData.type === CampaignType.VISIBILITY && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Campaign Access Type</h3>
              <p className="text-sm text-gray-600">This determines how promoters can join your visibility campaign</p>
            </div>
            ...
            <div className="space-y-4">
              <div className={`relative rounded-lg border-2 p-4 cursor-pointer transition-all ${
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <label htmlFor="visibility-public" className="block text-sm font-medium text-gray-900 cursor-pointer">
                      🌍 Public Campaign - Open to All Promoters
                    </label>
                    <p className="text-sm text-gray-600 mt-1">
                      Any qualified promoter can directly accept your campaign and start working. 
                      <strong> First come, first served.</strong> Best for campaigns that need quick execution and where multiple promoters can work simultaneously.
                    </p>
                    ...
                    <div className="mt-2 text-xs text-gray-500">
                      <strong>Recommended for:</strong> Simple visibility tasks, urgent deadlines
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={`relative rounded-lg border-2 p-4 cursor-pointer transition-all ${
                ...
                <div className="flex items-start space-x-3">
                  ...
                  />
                  <div className="flex-1">
                    <label htmlFor="visibility-private" className="block text-sm font-medium text-gray-900 cursor-pointer">
                      🔒 Private Campaign - Application Required
                    </label>
                    <p className="text-sm text-gray-600 mt-1">
                      Promoters must apply and you choose <strong>ONE promoter</strong> to work exclusively on your campaign. 
                      You review applications and select the best fit for your specific needs.
                    </p>
                    <div className="mt-2 text-xs text-orange-700 bg-orange-100 px-2 py-1 rounded inline-block">
                      ✓ Handpicked promoter • ✓ Exclusive work • ✓ Better quality control
                    </div>
                    <div className="mt-2 text-xs text-gray-500">
                      <strong>Recommended for:</strong> High-quality content, specific audience targeting
                    </div>
                  </div>
                </div>
              </div>
        ...
        {formData.type && formData.type !== CampaignType.VISIBILITY && (
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Private Campaign</p>
                <p className="text-sm text-gray-600">
                  {formData.type === CampaignType.CONSULTANT && 'Consultant campaigns are always private - promoters apply and you select the best expert.'}
                  {formData.type === CampaignType.SELLER && 'Seller campaigns are always private - promoters apply and you choose one to create and sell your products.'}
                  {formData.type === CampaignType.SALESMAN && 'Salesman campaigns are always private - promoters apply and you select the best sales representatives.'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="mb-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Advertiser Type(s) *</h3>
            <p className="text-sm text-gray-600">Select the categories that best describe your business</p>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">Provide the essential information about your campaign</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-2 flex justify-between items-center">
                <p className="text-sm text-gray-500">Make it clear and engaging</p>
                <span className={`text-sm ${formData.title.length > 90 ? 'text-orange-600' : 'text-gray-500'}`}>
            ...
            <div>
              ...
              <div className="mt-2 flex justify-between items-center">
                <p className="text-sm text-gray-500">This is your best opportunity to talk about your products! Be specific about your goals and requirements</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">🎯 Audience & Timeline</h3>
            <p className="text-sm text-gray-600">Define your target audience and campaign schedule</p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Target Audience */}
            <div className="lg:col-span-2">
              <label htmlFor="targetAudience" className="block text-sm font-medium text-gray-700 mb-3">
            ...
            {/* Start Date */}
            <div>
              <label htmlFor="startDate" className="block text-sm font-medium text-gray-700 mb-3">
                <div className="flex items-center">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 transition-all duration-200 ${
                  errors.deadline ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-gray-400'
                }`}
              />
              {errors.deadline && (
                <div className="mt-2 p-2 bg-red-50 border border-red-200 rounded-lg">
              ...
              <div className="mt-3 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                <p className="text-sm text-orange-800">
                  <strong>⏰ Important:</strong> Deadline must be at least 30 days after start date. After this date, your campaign will be automatically deactivated and no longer visible to promoters
                </p>
              </div>
              <p className="mt-2 text-sm text-gray-500">
                When should this campaign be completed and automatically deactivated?
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">📋 Requirements & Preferences</h3>
            <p className="text-sm text-gray-600">Set specific requirements and platform preferences for your campaign</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-gray-500">
                📱 Select the social media platforms you prefer for this campaign
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">Upload supporting content to help promoters understand your campaign</p>
          </div>
          
          <div className="grid grid-cols-1 gap-6">
            {/* Media File Upload */}
            <div>
              <label htmlFor="mediaFile" className="block text-sm font-medium text-gray-700 mb-3">
                <div className="flex items-center">
                  <PhotoIcon className="h-5 w-5 mr-2 text-blue-600" />
                  Supporting Media *
                </div>
              </label>
              <div className={`mt-1 flex justify-center px-6 pt-8 pb-8 border-2 border-dashed rounded-lg transition-all duration-200 ${
      ...
      {(formData.title || formData.description) && (
        <div className="mt-8 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-6">
          <div className="flex items-center mb-4">
            ...
            <h4 className="text-lg font-semibold text-gray-900">Campaign Preview</h4>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  {formData.type && (
                    <span className="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">
                      {formData.type === CampaignType.VISIBILITY && '👁️ Visibility'}
                  ...
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                    formData.isPublic ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'
                  }`}>
                ...
                {(formData.targetAudience || (formData.requirements && formData.requirements.length > 0) || (formData.preferredPlatforms && formData.preferredPlatforms.length > 0)) && (
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    {formData.targetAudience && (
                      <p className="text-sm text-gray-600 mb-2">
                        <strong className="text-gray-800">🎯 Target:</strong> {formData.targetAudience}
                      </p>
                    )}
                    {formData.requirements && formData.requirements.length > 0 && (
                      <p className="text-sm text-gray-600 mb-2">
                        <strong className="text-gray-800">📋 Requirements:</strong> {formData.requirements.filter(r => r.trim()).length} specified
                      </p>
                    )}
                    {formData.preferredPlatforms && formData.preferredPlatforms.length > 0 && (
                      <p className="text-sm text-gray-600">
                        <strong className="text-gray-800">📱 Platforms:</strong> {formData.preferredPlatforms.join(', ')}
                      </p>
                    )}
                  </div>
                )}
