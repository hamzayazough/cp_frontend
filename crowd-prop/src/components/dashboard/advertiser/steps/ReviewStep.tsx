        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              Your campaign will be created and made available to promoters
              immediately. You can always edit, pause, or manage it later from
              your campaign dashboard.
            </p>
            <div className="mt-4 p-3 bg-blue-100 rounded-lg border border-blue-200">
              <p className="text-sm text-blue-800 font-medium">
                💡 <strong>Next Steps:</strong> Once created, promoters will be
                able to see and apply for your campaign. You&apos;ll receive
