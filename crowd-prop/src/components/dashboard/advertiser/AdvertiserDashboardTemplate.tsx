...
export default function AdvertiserDashboardTemplate({ userName }: AdvertiserDashboardTemplateProps) {
  // Mock data for template
  const mockData = {
    stats: {
      spendingThisWeek: 2450.00,
    ...
    wallet: {
      balance: {
        currentBalance: 5240.50,
        pendingCharges: 1200.00,
        totalSpent: 18450.00,
        totalDeposited: 25000.00,
        minimumBalance: 100.00,
      },
      campaignBudgets: {
        totalAllocated: 8500.00,
        totalUsed: 3260.00,
        pendingPayments: 450.00,
      },
      totalLifetimeSpent: 18450.00,
      totalAvailableBalance: 4040.50,
    },
    recentTransactions: [
      {
        id: '1',
    ...
    recentMessages: [
      {
        id: '1',
        name: 'Sarah Johnson',
        message: 'I\'ve completed the first phase of your fashion campaign. The engagement is looking great!',
        time: '2 hours ago',
        avatar: '',
        isRead: false,
        threadId: '1',
      ...
      },
      {
        id: '2',
        name: 'Mike Chen',
        message: 'I\'m interested in your tech product launch. Can we discuss the requirements?',
        time: '5 hours ago',
        avatar: '',
        isRead: false,
        threadId: '2',
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{formatCurrency(mockData.stats.spendingThisWeek)}</p>
              <p className={`text-sm flex items-center mt-1 ${mockData.stats.spendingPercentageChange >= 0 ? 'text-blue-600' : 'text-green-600'}`}>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{formatNumber(mockData.stats.viewsToday)}</p>
              <p className={`text-sm flex items-center mt-1 ${mockData.stats.viewsPercentageChange >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                <ArrowTrendingUpIcon className="h-4 w-4 mr-1" />
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{mockData.stats.conversionsThisWeek}</p>
              <p className={`text-sm flex items-center mt-1 ${mockData.stats.conversionsPercentageChange >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                <ArrowTrendingUpIcon className="h-4 w-4 mr-1" />
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-2xl font-bold text-blue-600">
                        {formatCurrency(mockData.wallet.campaignBudgets.totalAllocated)}
                      </div>
