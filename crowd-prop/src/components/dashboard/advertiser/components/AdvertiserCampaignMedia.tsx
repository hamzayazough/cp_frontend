...
interface AdvertiserCampaignMediaProps {
  campaign: CampaignAdvertiser;
}

export default function AdvertiserCampaignMedia({
  campaign,
}: AdvertiserCampaignMediaProps) {
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">
          This campaign doesn&apos;t have any media files uploaded.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        <div className="w-full h-96 md:h-[500px] bg-gray-200 rounded-xl overflow-hidden relative">
