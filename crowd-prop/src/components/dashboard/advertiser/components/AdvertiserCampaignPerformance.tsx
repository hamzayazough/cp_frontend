...
export default function AdvertiserCampaignPerformance({
  ...
  const renderVisibilityPerformance = () => {
    ...
    const budgetProgress =
      budgetAllocated > 0 ? (spentBudget / budgetAllocated) * 100 : 0;
                    ...
                    <tr key={promoter.promoter.id} className="hover:bg-gray-50">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-500">
                              @
                              {promoter.promoter.email?.split("@")[0] ||
                                "unknown"}
                            </p>
                          </div>
                        </div>
                      ...
                      <td className="py-4 px-4">
                        <span className="text-sm text-gray-600">
                          {promoter.joinedAt
                            ? formatDate(promoter.joinedAt)
                            : "N/A"}
                        </span>
                      </td>
                      <td className="py-4 px-4">
                        <span className="text-sm font-medium text-green-600">
                          {formatCurrency(promoter.earnings || 0)}
                        </span>
                      </td>
                      <td className="py-4 px-4">
                        <span
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">
                  {campaign.chosenPromoters?.reduce(
                    (total, promoter) =>
                      total + (promoter.numberMeetingsDone || 0),
                    0
                  ) || 0}
                  <span className="text-sm text-purple-600">
                    /{meetingCount * (campaign.chosenPromoters?.length || 0)}
                  </span>
                </p>
              </div>
              <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                ...
                <tbody className="divide-y divide-gray-200">
                  {campaign.chosenPromoters.map((promoter) => (
                    <tr key={promoter.promoter.id} className="hover:bg-gray-50">
                      ...
                      <td className="py-4 px-4">
                        <span className="text-sm font-medium text-green-600">
                          {formatCurrency(promoter.budgetAllocated || 0)}
                        </span>
                      </td>
                      <td className="py-4 px-4">
                        <span className="text-sm text-gray-600">
                        ...
                        <div className="mt-3 pt-3 border-t border-orange-200">
                          <div className="space-y-2">
                            {deliverable.promoterWork
                              ?.slice(0, 2)
                              .map((work: CampaignWork, workIndex: number) => (
                                <div
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="mt-2">
              <p className="text-xs text-blue-600">Per sale commission</p>
            </div>
          </div>
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            ...
            <div className="mt-2">
              <p className="text-xs text-purple-600">Total paid to promoters</p>
            </div>
          </div>
  ...
  return (
    <div className="space-y-6">
      ...
      {campaign.campaign.type === CampaignType.VISIBILITY &&
        renderVisibilityPerformance()}
      {(campaign.campaign.type === CampaignType.CONSULTANT ||
        campaign.campaign.type === CampaignType.SELLER) &&
        renderConsultantSellerPerformance()}
